          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  'Aica Joy B.Bundalian',
                  style: TextStyle(
                    fontFamily: 'Orpheus',
                    fontSize: 35.0,
                    color: Color.fromARGB(255, 168, 83, 111),
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: Color.fromARGB(255, 175, 69, 104),
                    fontSize: 17.0,
                    letterSpacing: 2.5,
                ...
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    primary: Color.fromARGB(149, 61, 167, 167),
                    padding:
              ...
              child: ListTile(
                ...
                title: Text(
                  'Address:Macabito, Calasiao, Pang' +
                      '\nPhone Number: +639634807481' +
                      '\nEmail: bundalianaicajoyr@gmail.com',
                  style: TextStyle(
                    color: Color.fromARGB(255, 0, 0, 0),
                    fontFamily: 'Source Sans Pro',
                    fontSize: 18.0,
